...
traindir = '/Users/prashant/workspace/Kaggle/YelpChallenge/data/yelp_training_set'
testdir  = '/Users/prashant/workspace/Kaggle/YelpChallenge/data/yelp_test_set'
...
def convert_json_to_csv(jsonfilename, entity, header):
    ...
    for line in lines:
        ...
        record  = getattr(extract_table, entity)(jrec)
        try:
